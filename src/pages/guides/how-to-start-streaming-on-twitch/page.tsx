  ...
  return (
    ...
    >
      <Title
        ...
        description="Ready to start your streaming journey? This step-by-step guide will walk you through everything you need to know to begin streaming on Twitch, from basic setup to going live."
        align="left"
        className="mb-12"
      />
